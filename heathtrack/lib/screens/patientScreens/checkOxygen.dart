...
class CheckOxygen extends StatefulWidget {
  const CheckOxygen({super.key});

  @override
  State<CheckOxygen> createState() => _CheckOxygenState();
}

class _CheckOxygenState extends State<CheckOxygen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Check oxygen saturation'),
      ),
      body: Padding(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: (){
                ...
                setState(() {
                  result = DiagnosisEngine.diagnoseOxygenSaturationIssue(double.parse(valueController.text));
                });
              },
              style: ButtonStyle(
                padding: MaterialStatePropertyAll(EdgeInsets.symmetric(horizontal: 50,vertical: 10)),
                backgroundColor: MaterialStatePropertyAll(Color(0xff8db8eb)),
